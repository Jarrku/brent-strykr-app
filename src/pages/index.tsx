...
import { ExplainerContentCollectionItem, getContentfulClient, homeQuery, HomeResponse } from '@/lib/contentfulClient';
            ...
            <blockquote className="relative bg-white rounded-lg shadow-lg">
              <div className="rounded-t-lg px-6 py-8 sm:px-10 sm:pt-10 sm:pb-8">
                ...
                <div className="relative text-lg text-gray-700 font-medium mt-8">
                  ...
                  <p className="relative">{t.testimonial.review}</p>
                </div>
              </div>
              <cite className="relative flex items-center sm:items-start bg-indigo-600 rounded-b-lg not-italic py-5 px-6 sm:py-5 sm:pl-12 sm:pr-10 sm:mt-10">
                <div className="relative rounded-full border-2 border-white sm:absolute sm:top-0 sm:transform sm:-translate-y-1/2">
                  <img
                    ...
                    src={t.testimonial.authorImage.url}
                    alt={t.testimonial.authorImage.title}
                    width={80}
                    height={80}
                  />
                </div>
                <span className="relative ml-4 text-indigo-200 font-semibold leading-6 sm:ml-24 sm:pl-1">
                  <p className="text-white font-semibold sm:inline">{t.testimonial.authorName}</p>{' '}
                  <p className="sm:inline">{t.testimonial.authorSuffix}</p>
                </span>
              </cite>
            </blockquote>
          </div>
