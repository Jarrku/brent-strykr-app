  ...
  render() {
    ...
    return (
      <div className={styles.root}>
        ...
        >
          <img className={styles.backgroundImage} src={bgSrc} ref={this.bgRef} onLoad={this.updateSize} />
          ...
          <div ref={this.adWrapper} className={styles.adWrapper} style={{ transform: `matrix3d(${matrix.join(',')})` }}>
            <div
              style={{
                width: pct(1 / scaleX),
                height: pct(1 / scaleY),
